...
class HandCodedLaneFollower(object):
    ...
    def follow_lane(self, frame, image):
        # Main entry point of the lane follower
        show_image("orig", cv2.resize(image,(640,360)))
...
def detect_line_segments(cropped_edges):
    ...
    line_segments = cv2.HoughLinesP(cropped_edges, rho, angle, min_threshold, np.array([]), minLineLength=1,
                                    maxLineGap=1)
